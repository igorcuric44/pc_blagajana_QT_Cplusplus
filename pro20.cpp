...
class Promijenacijene: public QWidget {
   
public:
    Promijenacijene(QPushButton *tipka,QWidget *parent = 0);
    ~Promijenacijene();
private slots:
    void Potvrdi();
    void Odustani();    
...
private:
QPushButton *tipka;
QLineEdit *IdEdit,*CijenaEdit,*PdvEdit;
QPushButton *b1,*b2;
QSqlDatabase db=QSqlDatabase::database();
};
 
Promijenacijene::Promijenacijene(QPushButton *tipka,QWidget *parent): 
    QWidget(parent) 
{
    // Dummy UI
    //this->tipka=new QPushButton();
    ...
    QVBoxLayout *vbox = new QVBoxLayout();
    IdEdit = new QLineEdit();
    CijenaEdit = new QLineEdit();
    PdvEdit = new QLineEdit();
    
    IdEdit->setStyleSheet("font: bold;font-size: 20px;height: 30px;width: 120px;");
    CijenaEdit->setStyleSheet("font: bold;font-size: 20px;height: 30px;width: 120px;");
    PdvEdit->setStyleSheet("font: bold;font-size: 20px;height: 30px;width: 120px;");
  ...
  framex1->addRow("Id:", IdEdit);
  framex1->addRow("Cijena:",CijenaEdit);
  framex1->addRow("Pdv:",PdvEdit);
    
  framex1->labelForField(IdEdit)->setStyleSheet("font: bold;font-size: 20px;height: 30px;width: 120px;");
  framex1->labelForField(CijenaEdit)->setStyleSheet("font: bold;font-size: 20px;height: 30px;width: 120px;");
  framex1->labelForField(PdvEdit)->setStyleSheet("font: bold;font-size: 20px;height: 30px;width: 120px;");
  ...
  this->setLayout(vbox);
    ...
    connect(b2,&QPushButton::clicked, this,&Promijenacijene::Odustani);
  connect(b1,&QPushButton::clicked, this,&Promijenacijene::Potvrdi);
    centar po(this,350,300);
 //this->resize(350,150);
  this->setWindowTitle("Promijena cijene i pdv");
  this->show();
    
}
 
Promijenacijene::~Promijenacijene() {

QTextStream out(stdout);
out << "Zatvoreno promijena cijene" << endl;
this->tipka->setEnabled(true);
...
QSqlQuery query;
QString id= IdEdit->text();
QString cijena= CijenaEdit->text();
QString pdv= PdvEdit->text();
QString strx;
if(cijena!="" || pdv!="" || id!=""){
strx="update skladiste set cijena="+cijena+",pdv="+pdv+" where id="+id;
query.exec(strx);
}else{
QMessageBox(QMessageBox::Information, "Greska", "Greska", QMessageBox::Yes).exec();
...
class Promijenasifrarnik: public QWidget {
   
public:
    Promijenasifrarnik(QPushButton *tipka,QWidget *parent = 0);
    ~Promijenasifrarnik();
private slots:
    void Potvrdi();
    void Odustani();    
...
private:
QPushButton *tipka;
QLineEdit *IdEdit,*Cijena1Edit,*Cijena2Edit,*Pdv1Edit,*Pdv2Edit;
QPushButton *b1,*b2;
QSqlDatabase db=QSqlDatabase::database();
};
 
Promijenasifrarnik::Promijenasifrarnik(QPushButton *tipka,QWidget *parent): 
    QWidget(parent) 
{
    // Dummy UI
    //this->tipka=new QPushButton();
  ...
  this->setLayout(vbox);
    ...
    connect(b2,&QPushButton::clicked, this,&Promijenasifrarnik::Odustani);
  connect(b1,&QPushButton::clicked, this,&Promijenasifrarnik::Potvrdi);
    centar po(this,350,300);
 //this->resize(350,150);
  this->setWindowTitle("Promijena sifrarnik");
  this->show();
    
}
 
Promijenasifrarnik::~Promijenasifrarnik() {

QTextStream out(stdout);
out << "Zatvoreno promijena pdv" << endl;
this->tipka->setEnabled(true);
...
void Promijenasifrarnik::Potvrdi()
{
QTextStream out(stdout);
out << "potvrdi" << endl;
out<<"space"<<endl;
...
if(cijena1!="" || pdv1!="" || cijena2!="" || pdv2!=""   || id!=""){
strx="update sifrarnik set cijena1="+cijena1+",pdv1="+pdv1+",cijena2="+cijena2+",pdv2="+pdv2+" where id="+id;
query.exec(strx);
}else{
QMessageBox(QMessageBox::Information, "Greska", "Greska", QMessageBox::Yes).exec();
...
strx="update skladiste set kolicina= where id="+id;
query.exec(strx);
db.close();
}

void Promijenasifrarnik::Odustani()
{
QTextStream out(stdout);
out << "odustani" << endl;
this->close();
...
Prozor::Prozor(QWidget *parent)
  ...
  tipka9=new QPushButton("Promijena cijene i pdv");
  tipka10=new QPushButton("Promijena sifrarnik");
  tipka11=new QPushButton("Djelatnici");
  tipka12=new QPushButton("Postavke");
  tipka13=new QPushButton("Izlaz");
  
  //l->setStyleSheet("font: bold;background-color: red;font-size: 36px;height: 40px;width: 120px;");
  label->setStyleSheet("font: bold;background-color:white;font-size: 20px;height: 40px;width: 120px;qproperty-alignment: AlignCenter;");
  ...
  tipka12->setStyleSheet("font: bold;font-size: 20px;height: 30px;width: 120px;");
  tipka13->setStyleSheet("font: bold;font-size: 20px;height: 30px;width: 120px;");
  ...
  v_box->addWidget(tipka12);
  v_box->addWidget(tipka13);
  ...
  connect(tipka12, &QPushButton::clicked, this, &Prozor::onClick12);
  connect(tipka13, &QPushButton::clicked, this, &Prozor::onClick13);
...
void Prozor::onClick9() {
  ...
  QTextStream out(stdout);
  out << "Button clicked promijena cijene" << endl;
  promijenacijene= new Promijenacijene(tipka9);
  promijenacijene->setAttribute(Qt::WA_DeleteOnClose);
  promijenacijene->show();
  promijenacijene->activateWindow();
...
void Prozor::onClick10() {
  ...
  QTextStream out(stdout);
  out << "Button clicked promijena pdv" << endl;
  promijenasifrarnik= new Promijenasifrarnik(tipka10);
  promijenasifrarnik->setAttribute(Qt::WA_DeleteOnClose);
  promijenasifrarnik->show();
  promijenasifrarnik->activateWindow();
...
void Prozor::onClick11() {
  ...
  djelatnici= new Djelatnici(tipka11);
  djelatnici->setAttribute(Qt::WA_DeleteOnClose);
  djelatnici->show();
  djelatnici->activateWindow();
  tipka11->setEnabled(false);
  
}

void Prozor::onClick12() {
    
  QTextStream out(stdout);
  out << "Button clicked postavke" << endl;
  postavke= new Postavke(tipka12);
  postavke->setAttribute(Qt::WA_DeleteOnClose);
  postavke->show();
  postavke->activateWindow();
  tipka12->setEnabled(false);
  
}

void Prozor::onClick13() {
