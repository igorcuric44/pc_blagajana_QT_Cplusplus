...
class Blagajna : public QWidget {
  ...
  public:
    Blagajna(QPushButton *tipka,QWidget *blagajnax,QWidget *parent = 0);
    ~Blagajna();
...
Blagajna::Blagajna(QPushButton *tipka,QWidget *blagajnax,QWidget *parent)
    : QWidget(parent) {
...
blagajna=new Blagajna(this->tipka,this);
